...
import {addLiveForUser} from "../../../../../queries/lives";
...
const AddLive = () => {
    ...
    const onSubmit = async (values: FormValues) => {
        try {
            const {success} = await addLiveForUser(values)
            if (success) {
                router.push("/dashboard/lives");
                toast.success("Live Successfully Scheduled");
            }
        } catch (error) {
                            ...
                            <FormField
                                ...
                                render={({field}) => (
                                    <FormItem className="flex flex-col">
                                        ...
                                        <FormDescription>
                                            Select the date for your live session.
                                        </FormDescription>
                                        <FormMessage/>
                                    </FormItem>
                                )}
