...
export function SignupForm({role}: { role: "student" | "instructor" }) {
    ...
    const [isTermsSelected, setIsTermsSelected] = useState(true);
                ...
                <form onSubmit={handleSubmit}>
                    <div className="grid gap-4">
                        ...
                        <div className="flex justify-start items-center gap-2">
                            <input type="checkbox" onChange={handleOnTermsSelect}/>
                            <Link legacyBehavior href="/terms&conditions">
                                <a target="_blank" className="underline text-xs">Terms & conditions</a>
                            </Link>
                        </div>
                        <Button
                            type="submit"
                            className="w-full cursor-pointer"
                            disabled={isSubmitting || isTermsSelected}
                        >
