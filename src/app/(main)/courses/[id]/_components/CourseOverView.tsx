  ...
  return (
    <>
      ...
      <p className="mt-4">
        ...
        <br /> <br /> You&apos;ll be exposed to principles and strategies, but,
        more importantly, you&apos;ll learn how actually apply these abstract
        concepts by coding three different websites for three very different the
        audiences. Lorem ipsum is dummy text used in laying out print, graphic
        or web designs Lorem ipsum blinding shot chinwag knees.
      </p>
